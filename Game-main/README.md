...
1. **View Stats**: Click the "📊 View Stats" button on the main menu
2. **Export Logs**: Use the "📥 Export Log" button to download your game history
3. **Clear Data**: Use "🗑️ Clear Stats" to reset all statistics
